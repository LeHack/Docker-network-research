...
4.2.1 [Virtual Machine](#virtual-machine)  
4.2.2 [Docker registry](#docker-registry)  
4.2.3 [Deployment](#deployment)  
4.2.4 [Multiple host spanning network](#multiple-host-spanning-network)  
